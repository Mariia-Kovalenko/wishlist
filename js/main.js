...
window.addEventListener('DOMContentLoaded', () => {
    ...
    const addWishBtn = document.getElementById('add-wish-btn'),
        ...
        wishModal = document.querySelector('.wishes__modals');
    ...
    function createWishModal(wish){
        return `
        <div id="modal-wish" class="modal hide">
        ...
        <div class="wish__inner">
            ...
            <div class="wish__data">
                <div class="wish__name">${wish.name}</div>
                <div class="wish__category">${wish.category}</div>
                <div class="wish__describtion">${wish.describtion}</div>
            </div>
        </div>
        <div class="wish__icons">
            <button id = "done-wish">
    ...
    function renderWishModal(wish, i){
        wishModal.innerHTML = '';
